<template>
  ...
  <ErrorComponent
    ...
    :text="'Похоже что у вас нет лайков'"
  />
</template>
      ...
      tg.showPopup(
        {
          title: "Ошибка",
          message:
            "Не удалось загрузить анкеты, обновите приложение или возвращайтесь позже",
          buttons: [
