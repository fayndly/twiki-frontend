...
const ButtonAppeal = ({ onClick }: PropsButtonAppeal) => {
  return (
    <IconButton
      onClick={() => onClick()}
    ...
    >
      ...
      >
        ...
        <path d="M11 7C11 6.44772 11.4477 6 12 6C12.5523 6 13 6.44772 13 7V12C13 12.5523 12.5523 13 12 13C11.4477 13 11 12.5523 11 12V7Z" />
      </svg>
    </IconButton>
  );
};
    ...
    >
      ...
      <div className={styles.info}>
        ...
        <div className={styles.info_buttons}>
          <ButtonReaction
            onClick={() => handleClickButton(onLike)}
            type="like"
          />
          <ButtonReaction
            onClick={() => handleClickButton(onDislike)}
            type="dislike"
          />
        </div>
      </div>
